...
namespace DataStructure
{
    public class LinkedList
    {
        ...
        public Node InsertFuncAtPerticularPostion(int position, int data)
        {
            if(position < 1)
            {
        ...
        public void AddInReversrOrder(int data)
        {
        ...
        public void size()
        {
            ...
            System.Console.WriteLine("linked list length is :"+count);
        }
    }
}